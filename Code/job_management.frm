...
Begin VB.Form job_management 
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   615
      Left            =   5040
      Picture         =   "job_management.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   615
      Left            =   3840
      Picture         =   "job_management.frx":5A78
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   615
      Left            =   240
      Picture         =   "job_management.frx":A995
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   615
      Left            =   1440
      Picture         =   "job_management.frx":F69C
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command8 
      ...
      Height          =   615
      Left            =   2640
      Picture         =   "job_management.frx":1442B
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   8760
      Width           =   1215
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "job_management.frx":1922F
      Height          =   8175
      Left            =   240
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "job_management"
        ...
        If ms = 6 Then
            If Not Me.Adodc1.Recordset.EOF Then
                With Me.Adodc1.Recordset
                    ...
                    Me.DataGrid1.Columns(0).Caption = "Κωδικός Επαγγέλματος"
                    Me.DataGrid1.Columns(1).Caption = "Περιγραφή Επαγγέλματος"
...
Private Sub Form_Load()
    ...
    Me.Adodc1.Caption = "Εγγραφή " & Me.DataGrid1.Row + 1 & " από " & Me.Adodc1.Recordset.RecordCount
