...
Begin VB.Form typoi_esodwn_management 
   BackColor       =   &H00C0C0FF&
   ...
   Begin VB.CommandButton Command8 
      ...
      Height          =   615
      Left            =   2640
      Picture         =   "typoi_esodwn_management.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   615
      Left            =   1440
      Picture         =   "typoi_esodwn_management.frx":4E04
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   615
      Left            =   240
      Picture         =   "typoi_esodwn_management.frx":9B93
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   615
      Left            =   3840
      Picture         =   "typoi_esodwn_management.frx":E89A
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   615
      Left            =   5040
      Picture         =   "typoi_esodwn_management.frx":137B7
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   8760
      Width           =   1215
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "typoi_esodwn_management.frx":1922F
      Height          =   8175
      Left            =   240
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "typoi_esodwn_management"
...
Private Sub Adodc1_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    If adReason <> 10 Then
        If Not Me.Adodc1.Recordset.EOF Then
            If Me.Adodc1.Recordset.AbsolutePosition > 0 Then
                Me.Adodc1.Caption = "Εγγραφή " & Me.Adodc1.Recordset.AbsolutePosition & " από " & Me.Adodc1.Recordset.RecordCount
            Else
                Me.Adodc1.Caption = "Εγγραφή " & 0 & " από " & 0
            End If
        End If
    End If
        ...
        If ms = 6 Then
            If Not Me.Adodc1.Recordset.EOF Then
                With Me.Adodc1.Recordset
                    ...
                    Me.DataGrid1.Columns(0).Caption = "Κωδικός Τύπου Εσόδων"
                    Me.DataGrid1.Columns(1).Caption = "Περιγραφή Τύπων Εσόδων"
...
Private Sub DataGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    If Me.Adodc1.Recordset.AbsolutePosition > 0 Then
        Me.Adodc1.Caption = "Εγγραφή " & Me.Adodc1.Recordset.AbsolutePosition & " από " & Me.Adodc1.Recordset.RecordCount
    Else
        Me.Adodc1.Caption = "Εγγραφή " & 0 & " από " & Adodc1.Recordset.RecordCount
    End If
