...
Begin VB.Form typoi_eksodwn_management 
   BackColor       =   &H00C0C0FF&
   ...
   Begin VB.CommandButton Command8 
      ...
      Height          =   615
      Left            =   2640
      Picture         =   "typoi_eksodwn_management.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   615
      Left            =   1440
      Picture         =   "typoi_eksodwn_management.frx":4E04
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   615
      Left            =   240
      Picture         =   "typoi_eksodwn_management.frx":9B93
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   615
      Left            =   3840
      Picture         =   "typoi_eksodwn_management.frx":E89A
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   615
      Left            =   5040
      Picture         =   "typoi_eksodwn_management.frx":137B7
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   8760
      Width           =   1215
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "typoi_eksodwn_management.frx":1922F
      Height          =   8175
      Left            =   240
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "typoi_eksodwn_management"
        ...
        If ms = 6 Then
            If Not Me.Adodc1.Recordset.EOF Then
                With Me.Adodc1.Recordset
                    ...
                    Me.DataGrid1.Columns(0).Caption = "Κωδικός Τύπου Εξόδων"
                    Me.DataGrid1.Columns(1).Caption = "Περιγραφή Τύπων Εξόδων"
...
Private Sub Form_Load()
    ...
    Me.DataGrid1.Columns(0).Caption = "Κωδικός Τύπων Εξόδων"
    Me.DataGrid1.Columns(1).Caption = "Περιγραφή Τύπων Εξόδων"
