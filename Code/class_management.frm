...
Begin VB.Form class_management 
   BackColor       =   &H00C0C0FF&
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   615
      Left            =   5040
      Picture         =   "class_management.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   615
      Left            =   3840
      Picture         =   "class_management.frx":5A78
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command6 
      ...
      Height          =   615
      Left            =   240
      Picture         =   "class_management.frx":A995
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command7 
      ...
      Height          =   615
      Left            =   1440
      Picture         =   "class_management.frx":F69C
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command8 
      ...
      Height          =   615
      Left            =   2640
      Picture         =   "class_management.frx":1442B
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   8760
      Width           =   1215
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "class_management.frx":1922F
      Height          =   8175
      Left            =   240
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "class_management"
...
Private Sub Command2_Click()
    ...
    If Not Me.Adodc1.Recordset.EOF Then
        ...
        id = Me.Adodc1.Recordset![id_κατηγορίας_τμήματος]
    End If
    
    Me.Adodc1.Recordset.AddNew
    Me.Adodc1.Recordset.Fields(0) = id + 1
    Me.Adodc1.Recordset.UpdateBatch adAffectCurrent
    Me.Adodc1.Recordset.Sort = "id_κατηγορίας_τμήματος"
    Me.Adodc1.Recordset.MoveLast
    Me.DataGrid1.Col = 1
        ...
        If ms = 6 Then
            If Not Me.Adodc1.Recordset.EOF Then
                With Me.Adodc1.Recordset
                    ...
                    Me.DataGrid1.Columns(0).Caption = "Κωδικός Κατηγορίας Τμήματος"
                    Me.DataGrid1.Columns(1).Caption = "Κατηγορία Τμήματος Πισίνας"
...
Private Sub Form_Load()
    ...
    rs.Sort = "id_κατηγορίας_τμήματος"
