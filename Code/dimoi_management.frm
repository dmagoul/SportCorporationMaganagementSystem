...
Begin VB.Form dimoi_management 
   BackColor       =   &H00C0C0FF&
   ...
   Begin VB.CommandButton Command5 
      ...
      Height          =   615
      Left            =   5040
      Picture         =   "dimoi_management.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command4 
      ...
      Height          =   615
      Left            =   3840
      Picture         =   "dimoi_management.frx":5A78
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command3 
      ...
      Height          =   615
      Left            =   240
      Picture         =   "dimoi_management.frx":A995
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   615
      Left            =   1440
      Picture         =   "dimoi_management.frx":F69C
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   8760
      Width           =   1215
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   615
      Left            =   2640
      Picture         =   "dimoi_management.frx":1442B
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   8760
      Width           =   1215
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "dimoi_management.frx":1922F
      Height          =   8175
      Left            =   240
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "dimoi_management"
        ...
        If ms = 6 Then
            If Not Me.Adodc1.Recordset.EOF Then
                With Me.Adodc1.Recordset
                    ...
                    Me.DataGrid1.Columns(0).Caption = "Κωδικός Δήμου"
                    Me.DataGrid1.Columns(1).Caption = "Περιγραφή Δήμου"
