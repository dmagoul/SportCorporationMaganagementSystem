VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Rep_συνοπτική_εκτύπωση_ΠΡΟΠΟΝΗΤΩΝ_μελών 
   Bindings        =   "Rep_συνοπτική_εκτύπωση_ΠΡΟΠΟΝΗΤΩΝ_Μελών.dsx":0000
   Caption         =   "Συνοπτική Εκτύπωση Προπονητών Μελών"
   ClientHeight    =   9525
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   14880
   ...
   BottomMargin    =   1440
   _Settings       =   7
   DataMember      =   "συνοπτική_εκτύπωση_επιλεγμένων_μελών"
   NumSections     =   5
   SectionCode0    =   1
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Μέλη Προπονητές Συλλόγου"
      EndProperty
      ItemType1       =   7
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1485
         Object.Height          =   1545
         Picture         =   "Rep_συνοπτική_εκτύπωση_ΠΡΟΠΟΝΗΤΩΝ_Μελών.dsx":001A
      EndProperty
      ItemType2       =   3
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      _Version        =   393216
      Name            =   "συνοπτική_εκτύπωση_επιλεγμένων_μελών_Detail"
      Object.Height          =   957
      NumControls     =   7
      ItemType0       =   4
   ...
   EndProperty
End
Attribute VB_Name = "Rep_συνοπτική_εκτύπωση_ΠΡΟΠΟΝΗΤΩΝ_μελών"
...
Private Sub DataReport_Initialize()
    ...
    s_string = "[Προπονητής] Like True"
    Poseidon_DB.rsσυνοπτική_εκτύπωση_επιλεγμένων_μελών.Filter = s_string
    s_sort = "[Επώνυμο]"
    Poseidon_DB.rsσυνοπτική_εκτύπωση_επιλεγμένων_μελών.Sort = s_sort
    Rep_συνοπτική_εκτύπωση_ΠΡΟΠΟΝΗΤΩΝ_μελών.Refresh
